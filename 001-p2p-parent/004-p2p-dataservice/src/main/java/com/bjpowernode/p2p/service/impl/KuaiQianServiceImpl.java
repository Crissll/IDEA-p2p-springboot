...
import com.bjpowernode.p2p.util.Pkipair;
...
public class KuaiQianServiceImpl implements KuaiQianService {
    @Override
    public Map makeKuaiQianRequestParam(String rechargeMoney, String name, String phone,String OrderId) {
        ...
        String bgUrl = "http://mrl.free.idcfengye.com/kq/notify";
        //网关版本，固定值：v2.0,该参数必填。
        String version =  "v2.0";
        ...
        rechargeMoney=String.valueOf((int)(Double.parseDouble(rechargeMoney)*100));
        String orderAmount = rechargeMoney;
    ...
    public String appendParam(String returns, String paramId, String paramValue,Map res) {
        if (returns != "") {
